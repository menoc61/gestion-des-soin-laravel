...
<head>
    ...
    <title>Gestion soin - <?php echo $__env->yieldContent('title'); ?> </title>
            ...
            <ul class="navbar-nav custom-colors sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <?php endif; ?>
                ...
                <?php if(Auth::user()->can('create invoice') ||
                    ...
                    <!-- Heading -->
                    <div class="sidebar-heading">
                        <?php echo e(__('sentence.Billings')); ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse"
                            ...
                            <span><?php echo e(__('sentence.Billings')); ?></span>
                        </a>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item"
                                    href="<?php echo e(route('user.all')); ?>"><?php echo e(__('sentence.All Users')); ?></a>
                                <a class="collapse-item"
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseSettings" class="collapse" aria-labelledby="headingPages"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item"
                                    href="<?php echo e(route('sms_settings.edit')); ?>"><?php echo e(__('sentence.SMS Gateway Setup')); ?></a>
                            </div>
                        </div>
                    </li>
                <?php endif; ?>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('patient.view', ['id' => Auth::user()->id])); ?>">
                    ...
                    <div class="container my-auto">
                        <div class="copyright my-auto">
                            <span>Copyright &copy; Created by <a href="https://digit-tech-innov.com/" target="_blank">
                                    DIGIT-TECH-INNOV SARL</a> <?php echo e(date('Y')); ?></span>
...
<?php /**PATH C:\Users\gille\workspace\gestion-des-soin-laravel\resources\views/layouts/master.blade.php ENDPATH**/ ?>
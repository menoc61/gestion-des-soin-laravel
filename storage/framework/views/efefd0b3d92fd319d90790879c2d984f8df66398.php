                    ...
                    <div class="col-md-12">
                        ...
                        <div class="">
                            <div class="text-center">
                                <b><?php echo e(App\Setting::get_option('system_name')); ?></b><br>
                                <b><?php echo e(App\Setting::get_option('title')); ?></b><br>
                                <b><?php echo e(App\Setting::get_option('address')); ?></b><br>
                                <b><?php echo e(App\Setting::get_option('phone')); ?></b><br>
                                <b><?php echo e(App\Setting::get_option('hospital_email')); ?></b>
                            </div>
                        </div>
                    </div>

                    <div class="border-top mt-5">
                        <h5 class="text-center mt-4 "><b><?php echo e(__('sentence.Invoice_for_care')); ?> </b></h5>
                    </div>

                    <div class="col-12 border-top mt-4">
                        <p class="mt-4">
                            <b><?php echo e(__('sentence.Date')); ?> :</b> <?php echo e($billing->created_at->format('d M Y h:m:s')); ?><br>
                        ...
                        <div class="col">
                            ...
                            <?php if(empty(!$billing_item)): ?>
                                <?php if(App\Setting::get_option('vat') > 0): ?>
                                    <tr>
                                        <td colspan="2"><strong
                                                class="float-right"><?php echo e(__('sentence.Sub-Total')); ?></strong></td>
                                        <td align="center"><strong><?php echo e($billing_items->sum('invoice_amount')); ?>

                                                <?php echo e(App\Setting::get_option('currency')); ?></strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><strong class="float-right"><?php echo e(__('sentence.VAT')); ?></strong>
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <strong><?php echo e($billing_items->sum('invoice_amount') + ($billing_items->sum('invoice_amount') * App\Setting::get_option('vat')) / 100); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HS\gestion-des-soin-laravel\resources\views/billing/view.blade.php ENDPATH**/ ?>
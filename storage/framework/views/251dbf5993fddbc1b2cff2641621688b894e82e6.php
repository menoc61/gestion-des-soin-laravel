            ...
            <div class="col-md-4">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('sentence.follow')); ?></h6>
                    </div>
                    <div class="card-body">
                        statistics
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control multiselect-drug" name="trade_name[]" id="drug" tabindex="-1" aria-hidden="true" required>
                                            <?php if(@empty($drugs)): ?>
                                                <option value="" disabled selected><?php echo e(__('sentence.Select Drug')); ?>...</option>
                                            <?php else: ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\gille\workspace\gestion-des-soin-laravel\resources\views/prescription/follow.blade.php ENDPATH**/ ?>
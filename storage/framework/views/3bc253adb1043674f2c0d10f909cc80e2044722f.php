                ...
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('role.store_edit_role')); ?>">
                        <div class="form-group row">
                            <label for="Name" class="col-sm-3 col-form-label"><?php echo e(__('sentence.Name')); ?><font
                        ...
                        <hr>
                        <div class="form-group row">
                            <label for="Email" class="col-sm-3 col-form-label"><?php echo e(__('sentence.Permissions')); ?><font
                                    color="red">*</font></label>
                            <div class="col-sm-9">
                                <select id="example-multiple-selected" multiple="multiple" name="permissions[]">
                                    <?php $__empty_1 = true; $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option value="<?php echo e($permission->name); ?>"
                                            <?php if($role->hasPermissionTo($permission->id)): ?> selected="selected" <?php endif; ?>>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\gestion des soins\v1.0\resources\views/role/edit.blade.php ENDPATH**/ ?>
                        ...
                        <div class="tab-pane fade" id="Billing" role="tabpanel" aria-labelledby="Billing-tab">
                            ...
                            <div class="col-lg-4 mb-4">
                              <div class="card bg-danger text-white shadow">
                                <div class="card-body">
                                  ...
                                  <div class="text-white small"><?php echo e(Collect($invoices)->whereIn('payment_status',['Partially Paid','Unpaid'])->sum('due_amount')); ?> <?php echo e(App\Setting::get_option('currency')); ?></div>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <table class="table">
                            ...
                            <tr>
                              ...
                              <td><label class="badge badge-primary-soft"><?php echo e($invoice->created_at->format('d M Y h:m:s')); ?></label></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\gestion des soins\v4.0\resources\views/patient/view.blade.php ENDPATH**/ ?>

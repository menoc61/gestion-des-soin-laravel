            ...
            <div class="row">
               <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                     <label for="patient_name"><?php echo e(__('sentence.Patient')); ?> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add patient')): ?> - <a href="<?php echo e(route('patient.create')); ?>" class="text-muted"><?php echo e(__('sentence.New Patient')); ?></a> <?php endif; ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\codecanyon-28707541-doctorino-doctor-chamber-management-system\v4.0\resources\views/appointment/create.blade.php ENDPATH**/ ?>
               ...
               <div class="form-group row">
                 ...
                 <!-- Content for DIAGNOSE MAIN section -->
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <div class="form-group row">
                                    <label for="signes-particuliers-mains" class="col-sm-3 col-form-label"><?php echo e(__('sentence.particular type hand')); ?></label>
                                    <div class="col-sm-9">
                            ...
                            <hr>
                            <div class="form-group row">
                                <label for="soin" class="col-sm-3 col-form-label"><?php echo e(__('sentence.soin')); ?></label>
                                <div class="col-sm-9">
                            ...
                            <hr>
                            <div class="form-group row">
                                <label for="vernis" class="col-sm-3 col-form-label"><?php echo e(__('sentence.vernis')); ?></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-9">
                                    <label for="relief" class="col-sm-3 col-form-label"><?php echo e(__('sentence.relief')); ?></label>
                                ...
                                <div class="col-sm-9">
                                <label for="sp1" class="col-sm-3 col-form-label"><?php echo e(__('sentence.signe particulier')); ?></label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <label for="sp2" class="col-sm-3 col-form-label"><?php echo e(__('sentence.signe particulier')); ?></label>
                ...
                <div class="form-group row " id="section-DIAGNOSE PIED">
                 ...
                 <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                    <label for="Etat-generale-des-mains" class="col-sm-3 col-form-label"><?php echo e(__('sentence.general foot state')); ?></label>
                                    <div class="col-sm-9">
                            ...
                            <hr>
                            <div class="form-group row">
                                    <label for="signes-particuliers-mains" class="col-sm-3 col-form-label"><?php echo e(__('sentence.particular type foot')); ?></label>
                                    <div class="col-sm-9">
                                        <select id="signes-particuliers-mains" class="form-control" multiple="multiple" name="signes_particuliers_mains[]">
                                            <option value="Rousseurs">Rousseurs</option>
                                            <option value="Pigmentation">Pigmentation</option>
                            ...
                            <div class="form-group row">
                            <div class="col-sm-9">
                                <label for="cicatrices" class="col-sm-3 col-form-label"><?php echo e(__('sentence.general foot state')); ?></label>
                            ...
                            <div class="col-sm-9">
                                <label for="cicatrices" class="col-sm-3 col-form-label"><?php echo e(__( 'sentence.particular type foot')); ?></label>
                                <select class="form-control" id="cicatrices"  name="cicatrices">
                                    <option value="oui"><?php echo e(__('oui')); ?></option>
                                    <option value="non"><?php echo e(__('non')); ?></option>
                                </select>
                            ...
                            <div class="col-sm-9">
                                <label for="cicatrices" class="col-sm-3 col-form-label"><?php echo e(__('sentence.taches foot')); ?></label>
                                <select class="form-control" id="cicatrices"  name="cicatrices">
                                    <option value="oui"><?php echo e(__('oui')); ?></option>
                                    <option value="non"><?php echo e(__('non')); ?></option>
                                </select>
                            ...
                            <div class="col-sm-9">
                                <label for="cicatrices" class="col-sm-3 col-form-label"><?php echo e(__('sentence.aureoles')); ?></label>
                                <select class="form-control" id="cicatrices"  name="cicatrices">
                                    <option value="oui"><?php echo e(__('oui')); ?></option>
                                    <option value="non"><?php echo e(__('non')); ?></option>
                                </select>
                            ...
                            <div class="col-sm-9">
                                <label for="cicatrices" class="col-sm-3 col-form-label"><?php echo e(__('sentence.veines face ext')); ?></label>
                                <select class="form-control" id="cicatrices"  name="cicatrices">
                                    <option value="oui"><?php echo e(__('sentence.oui')); ?></option>
                                    <option value="non"><?php echo e(__('sentence.non')); ?></option>
                                </select>
                            ...
                            <div class="col-sm-9">
                                <label for="cicatrices" class="col-sm-3 col-form-label"><?php echo e(__('sentence.veines face int')); ?></label>
                                <select class="form-control" id="cicatrices"  name="cicatrices">
                                    <option value="oui"><?php echo e(__('sentence.oui')); ?></option>
                                    <option value="non"><?php echo e(__('sentence.non')); ?></option>
                                </select>
                            ...
                            <div class="col-sm-9">
                                <label for="cicatrices" class="col-sm-3 col-form-label"><?php echo e(__('sentence.douleur talon')); ?></label>
                                <select class="form-control" id="cicatrices"  name="cicatrices">
                                    <option value="oui"><?php echo e(__('sentence.oui')); ?></option>
                                    <option value="non"><?php echo e(__('sentence.non')); ?></option>
                                </select>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\codecanyon-28707541-doctorino-doctor-chamber-management-system\v4.0\resources\views/test/create.blade.php ENDPATH**/ ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('test.store_id', ['id' => $userId])); ?>">
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo e(__('sentence.Patient Name')); ?><font
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\gille\workspace\gestion-des-soin-laravel\resources\views/test/create_By_user.blade.php ENDPATH**/ ?>
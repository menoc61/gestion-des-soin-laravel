            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <li class="nav-item">
                  ...
                  <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('billing.create')); ?>"><?php echo e(__('sentence.Create User')); ?></a>
                        <a class="collapse-item" href="<?php echo e(route('users.all')); ?>"><?php echo e(__('sentence.All Users')); ?></a>
...
</html><?php /**PATH C:\xampp\htdocs\doctorino\v3.4\resources\views/layouts/master.blade.php ENDPATH**/ ?>
                    ...
                    <form method="post" action="<?php echo e(route('patient.create')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-row col-md-10 ml-10">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="type_patient"><?php echo e(__('sentence.Type of patient')); ?><font color="red">*
                                        </font></label>
                                    <div class="col-md-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\gille\workspace\gestion-des-soin-laravel\resources\views/patient/create.blade.php ENDPATH**/ ?>
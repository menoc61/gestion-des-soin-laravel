            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                 <form method="post" action="<?php echo e(route('user.store')); ?>">
                    ...
                    <div class="form-group row">
                      <label for="Password" class="col-sm-3 col-form-label"><?php echo e(__('sentence.Password Confirmation')); ?><font color="red">*</font></label>
                      <div class="col-sm-9">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\codecanyon-28707541-doctorino-doctor-chamber-management-system\v4.0\resources\views/user/create.blade.php ENDPATH**/ ?>
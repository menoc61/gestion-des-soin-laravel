...
<head>
    ...
    <title>Sai i lama - {{ __('sentence.View Invoice') }}
    </title>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <p class="float-right"><b>{{ __('sentence.Date') }} :</b>
                                                    {{ $billing->created_at->format('d-m-Y') }}<br>
                                                    <b>{{ __('sentence.Reference') }} :</b>
                                            ...
                                            <div class="col">
                                                ...
                                                <table class="table">
                                                    <tr>
                                                        ...
                                                        <td width="30%" align="center">{{ __('sentence.Amount') }}
                                                        </td>
                                                    </tr>
                                                ...
                                                @empty(!$billing_item)
                                                    @if (App\Setting::get_option('vat') > 0)
                                                        <tr>
                                                            <td colspan="2">
                                                                <strong>{{ __('sentence.Sub-Total') }}</strong></td>
                                                            <td align="center">
                                                                <strong>{{ $billing_items->sum('invoice_amount') }}
                                                                    {{ App\Setting::get_option('currency') }}</strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
                                                                <strong>{{ __('sentence.VAT') }}</strong></td>
                                                            <td align="center"><strong>
                                                                    {{ App\Setting::get_option('vat') }}%</strong></td>
                                                        </tr>
                                                    @endif
                                                    <tr>
                                                        <td colspan="2"><strong>{{ __('sentence.Total') }}</strong>
                                                        </td>
                                                        <td align="center">

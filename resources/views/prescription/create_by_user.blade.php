        ...
        <div class="row justify-content-center mt-4">
            ...
            <div class="col-md-8">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <select class="form-control multiselect-search" name="trade_name[]" required>
                            @if (@empty($drugs))
                ...
                <div class="card shadow form-row mb-4">
                    <div class="card-header py-3">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <select class="form-control multiselect-search" name="test_name[]" id="testSelect" required>
                                @if (@empty($tests))
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            testSelect.addEventListener('change', function() {
                ...
                var selectedTestName = selectedOption.text;
                nomInput.value = selectedTestName;
            });
        });
    </script>
@endsection

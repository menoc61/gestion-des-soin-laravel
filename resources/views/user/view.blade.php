                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <h4 class="text-center"><b>{{ $patient->name }}</b> <label class="badge badge-primary-soft"> <a
                                        href="{{ url('patient/edit/' . $patient->id) }}"><i class="fa fa-pen"></i></a></label>
                            </h4>
                            <hr>
                                ...
                                <div class="tab-pane fade show active" id="profile" role="tabpanel"
                                    ...
                                    @forelse($historys as $history)
                                        <div class="alert alert-warning">
                                            <p class="text-danger font-size-12">{!! clean($history->title) !!} -
                                                {{ $history->created_at }}<span class="float-right"><i class="fa fa-trash"
                                    ...
                                    <table class="table">
                                        ...
                                        @forelse($invoices as $invoice)
                                            <tr>
                                                ...
                                                <td><label
                                                        class="badge badge-primary-soft">{{ $invoice->created_at->format('d M Y') }}</label>
                                                </td>

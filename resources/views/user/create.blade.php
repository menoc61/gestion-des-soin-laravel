            ...
            <div class="card-body">
                <form method="post" action="{{ route('user.store') }}">
                    ...
                    <div class="form-group row">
                        <label for="Name" class="col-sm-3 col-form-label">{{ __('sentence.Full Name') }}
                            <font
                                color="red">*</font>
                        </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="Email" class="col-sm-3 col-form-label">{{ __('sentence.Email Adress') }}
                            <font
                                color="red">*</font>
                        </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="Password" class="col-sm-3 col-form-label">{{ __('sentence.Password') }}
                            <font
                                color="red">*</font>
                        </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="Password"
                            class="col-sm-3 col-form-label">{{ __('sentence.Password Confirmation') }}
                            <font color="red">*</font>
                        </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="fonction_user" class="col-sm-3 col-form-label">Type de User
                            <font color="red">*
                            </font>
                        </label>
                        <div class="col-md-6">

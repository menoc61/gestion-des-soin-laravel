            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <li class="nav-item">
                  ...
                  <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('user.create') }}">{{ __('sentence.Create User') }}</a>
                        <a class="collapse-item" href="{{ route('user.all') }}">{{ __('sentence.All Users') }}</a>
                        <a class="collapse-item" href="{{ route('roles.all') }}">{{ __('sentence.Roles & Permissions') }}</a>
                     </div>
                  </div>
               </li>
               @endif
                  ...
                  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                     ...
                     <div class="dropdown shortcut-menu mr-4">
                       ...
                       <div class="dropdown-menu shadow">
                        @if(Auth::user()->can('create prescription'))
                              <a class="dropdown-item" href="{{ route('prescription.create') }}">{{ __('sentence.Prescription') }}</a>
                        @endif
                        @if(Auth::user()->can('add patient'))
                              <a class="dropdown-item" href="{{ route('patient.create') }}">{{ __('sentence.Patient') }}</a>
                        @endif
                        @if(Auth::user()->can('create appointment'))
                              <a class="dropdown-item" href="{{ route('appointment.create') }}">{{ __('sentence.Appointment') }}</a>
                        @endif
                        @if(Auth::user()->can('create invoice'))
                              <a class="dropdown-item" href="{{ route('billing.create') }}">{{ __('sentence.Invoice') }}</a>
                        @endif
                     ...
                     <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ route('patient.search') }}" method="post">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" name="term">
                            @csrf

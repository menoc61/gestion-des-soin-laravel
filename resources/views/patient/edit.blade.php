            ...
            <form method="post" action="{{ route('patient.store_edit') }}" enctype="multipart/form-data">
             ...
             <div class="form-row">
                ...
                <div class="form-group col-md-6">
                   ...
                   <input type="date" class="form-control" id="Birthday" name="birthday" value="{{ $patient->Patient->birthday }}" autocomplete="off">
                </div>
             </div>
             <div class="form-row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <div class="col-md-3">
                        <select class="form-control" id="morphology_patient" multiple="multiple" name="morphology[]">
                            <option value="{{ $patient->Patient->morphology }}" selected="selected">{{ $patient->Patient->morphology }}</option>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <div class="col-md-3">
                        <select class="form-control" id="alimentation_patient" multiple="multiple" name="alimentation[]">
                            <option value="{{ $patient->Patient->alimentation }}" selected="selected">{{ $patient->Patient->alimentation }}</option>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <div class="col-md-3">
                        <select class="form-control" id="digestion_patient" multiple="multiple" name="digestion[]">
                            <option value="{{ $patient->Patient->digestion }}" selected="selected">{{ $patient->Patient->digestion }}</option>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <div class="col-md-3">
                        <select class="form-control" id="typ_patient" multiple="multiple" name="type_patient[]">
                            <option value="{{ $patient->Patient->type_patient }}" selected="selected">{{ $patient->Patient->type_patient }}</option>
             ...
             <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="hobbie" name="hobbie" value="{{ $patient->Patient->hobbie }}">
                </div>
                <div class="form-group col-md-6">
                  <label for="medication">{{ __('sentence.Medication') }}<font color="red">*</font></label>
                  <input type="text" class="form-control" id="medication" name="medication" value="{{ $patient->Patient->medication }}">
                </div>
                <div class="form-group col-md-6">
                  <label for="allergie">{{ __('sentence.Allergies') }}<font color="red">*</font></label>
                  <input type="text" class="form-control" id="allergie" name="allergie" value="{{ $patient->Patient->allergie }}">
                </div>
                <div class="form-group col-md-6">
                  <label for="request">{{ __('sentence.Special Requests') }}<font color="red">*</font></label>
                  <input type="text" class="form-control" id="request" name="demande" value="{{ $patient->Patient->demande }}">
                </div>
             </div>
             <div class="form-row">
                <div class="form-group col-md-6">

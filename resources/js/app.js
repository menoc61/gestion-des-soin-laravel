        ...
        $.ajax(
            {
                ...
                success: function(array) {
                    ...
                    $.each(array, function(key, value) {
                        ...
                        options =
                            options +
                            '<div class="col-sm-6 col-md-4 mb-2"><button class="btn btn-' +
                            btn +
                            ' btn-block" data-toggle="modal" data-target="#RDVModalSubmit" data-rdv_date="' +
                            date +
                            '" data-rdv_time_start="' +
                            value.start +
                            '" data-rdv_time_end="' +
                    ...
                    $("#RDVModalSubmit").on("show.bs.modal", function(event) {
                        ...
                        var praticienId = button.data("praticien_id");
                        // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
                        // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
                        var modal = $(this);
